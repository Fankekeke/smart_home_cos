<template>
  <a-modal v-model="show" title="修改操作记录" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='操作记录名称' v-bind="formItemLayout">
            <a-input v-decorator="[
            'name',
        ...
        <a-col :span="12">
          <a-form-item label='操作记录类型' v-bind="formItemLayout">
...
export default {
  ...
  methods: {
    selectTypeList () {
      this.$get('/cos/record-type/list').then((r) => {
