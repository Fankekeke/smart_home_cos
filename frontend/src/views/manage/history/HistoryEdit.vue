<template>
  <a-modal v-model="show" title="修改历史上报数据" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='历史上报数据名称' v-bind="formItemLayout">
            <a-input v-decorator="[
            'name',
        ...
        <a-col :span="12">
          <a-form-item label='历史上报数据类型' v-bind="formItemLayout">
...
export default {
  ...
  computed: {
    ...
    show: {
      get: function () {
        return this.historyEditVisiable
      },
      set: function () {
      }
    }
  ...
  methods: {
    selectTypeList () {
      this.$get('/cos/history-type/list').then((r) => {
