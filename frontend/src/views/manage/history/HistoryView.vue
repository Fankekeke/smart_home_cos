<template>
  <a-modal v-model="show" title="历史上报数据详情" @cancel="onClose" :width="1200">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="userData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">历史上报数据信息</span></a-col>
        <a-col :span="8"><b>历史上报数据名称：</b>
          {{ userData.name }}
        </a-col>
        <a-col :span="8"><b>历史上报数据编号：</b>
          {{ userData.code }}
        </a-col>
